module View.EditData exposing (view)
    ...
    case model.dataFile of
        ...
        Just dataFile ->
            E.column
                ...
                (List.map (editDatum model)
                    (Data.filterData model.time model.jobFilter model.taskFilter model.sinceDayFilter dataFile.data)
                )


editDatum : FrontendModel -> Data -> Element FrontendMsg
editDatum model data =
    case data of
        ...
        Quantity { start, end, value, desc } ->
            E.row [ E.spacing 8 ]
                [ E.el [ E.width (E.px 100) ] (E.text <| DateTimeUtility.zonedTimeString model.zone start)
                , E.el [ E.width (E.px 100) ] (E.text <| DateTimeUtility.zonedTimeString model.zone end)
